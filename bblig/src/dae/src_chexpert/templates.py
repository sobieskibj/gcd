...
def autoenc_base():
    ...
    conf.T_eval = 20
    conf.T = 1000
    conf.in_channels = 1 # one-channel chexpert
    conf.make_model_conf()
    return conf
...
def imagenet256_autoenc():
    ...
    conf.net_ch_mult = (1, 1, 2, 2, 4, 4)
    conf.net_enc_channel_mult = (1, 1, 2, 2, 4, 4, 4)
    conf.eval_every_samples = 10_000_000 # NOTE: TBD
    conf.eval_ema_every_samples = 10_000_000 # NOTE: TBD
    conf.total_samples = 500_000_000 # NOTE: TBD
    conf.batch_size = 64
    conf.make_model_conf()
...
def chexpert224_autoenc():
    conf = ffhq256_autoenc()
    conf.in_channels = 1 # NOTE: Hardcoded, might need change
    conf.img_size = 224
    conf.net_ch = 128
    conf.net_ch_mult = (1, 1, 2, 2, 4, 4)
    conf.net_enc_channel_mult = (1, 1, 2, 2, 4, 4, 4)
